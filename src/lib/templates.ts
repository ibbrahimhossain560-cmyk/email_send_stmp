...
<h1 style="color:#fff;margin:0;font-size:32px;font-weight:800;letter-spacing:-0.5px">${v.subject}</h1>
</td></tr>
...
<p style="color:#4a5568;font-size:15px;line-height:1.9;margin:0 0 25px;white-space:pre-wrap">${v.body}</p>
...
<h1 style="color:#fff;margin:20px 0 0;font-size:30px;font-weight:800;letter-spacing:-0.5px">${v.subject}</h1>
</td></tr>
<tr><td style="padding:40px">
<p style="color:#1a1a2e;font-size:17px;line-height:1.7;margin:0 0 15px">Hi <strong>${v.recipientName}</strong>,</p>
<p style="color:#4a5568;font-size:15px;line-height:1.9;margin:0 0 30px;white-space:pre-wrap">${v.body}</p>
<div style="text-align:center;margin:35px 0 10px">
...
<tr><td style="padding:40px">
<p style="color:#1a1a2e;font-size:17px;line-height:1.7;margin:0 0 15px">Hi <strong>${v.recipientName}</strong>,</p>
<p style="color:#4a5568;font-size:15px;line-height:1.9;margin:0 0 20px;white-space:pre-wrap">${v.body}</p>
...
<p style="color:#4a5568;font-size:15px;line-height:1.8;margin:0 0 30px;white-space:pre-wrap">${v.body}</p>
...
<h1 style="color:#fff;margin:0;font-size:30px;font-weight:800;letter-spacing:-0.5px">${v.subject}</h1>
</td></tr>
<tr><td style="padding:40px">
<p style="color:#1a1a2e;font-size:17px;line-height:1.7;margin:0 0 15px">Hi <strong>${v.recipientName}</strong>,</p>
<p style="color:#4a5568;font-size:15px;line-height:1.9;margin:0 0 30px;white-space:pre-wrap">${v.body}</p>
...
<p style="color:#4a5568;font-size:16px;line-height:1.9;margin:0 0 25px;white-space:pre-wrap">${v.body}</p>
...
<h1 style="color:#f1f5f9;margin:0;font-size:28px;font-weight:800;letter-spacing:-0.5px">${v.subject}</h1>
</td></tr>
...
<p style="color:#44403c;font-size:16px;line-height:2;margin:0;white-space:pre-wrap">${v.body}</p>
</div>
...
<p style="color:#374151;font-size:15px;line-height:1.9;margin:0 0 25px;white-space:pre-line">${v.body}</p>
...
<h1 style="color:#1e293b;margin:0;font-size:24px;font-weight:800;letter-spacing:-0.5px">${v.subject}</h1>
</td></tr>
